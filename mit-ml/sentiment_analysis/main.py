...
# Your code here
result=p1.classifier_accuracy(p1.pegasos,train_bow_features,test_bow_features, train_labels,test_labels,T=25,L=0.01)
print(result)
#-------------------------------------------------------------------------------
# Assign to best_theta, the weights (and not the bias!) learned by your most
# accurate algorithm with the optimal choice of hyperparameters.
#-------------------------------------------------------------------------------
# p1.pegasos(train_bow_features, train_labels,T=25,L=0.01)
# best_theta = p1.pegasos(train_bow_features, train_labels,T=25,L=0.01) # Your code here
# # print(best_theta)
